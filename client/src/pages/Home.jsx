...
const Home = () => {
  ...
  const [isLogin, setIsLogin] = useState(null); // start with null
  const [loading, setLoading] = useState(true); // optional loading state

  useEffect(() => {
    const checkLogin = () => {
      const status = fetchIsLogin();
      setIsLogin(status);
      setLoading(false);
    };
        ...
        !isLogin ? (
          <div className=''>
            ...
            <div className='lg-real:p-[4%] lg_md:pl-[140px] lg-real:max-w-[75%] w-full lg_md:px-[15%] md:px-[10%] md:py-[8%] px-[5%] py-[10%]'>
              ...
              <h1 className='md:text-5xl font-bold mb-3 leading-[1.2] text-2xl text-[#000727]'>Streamline Your Workflow - Collaborate in Real Time with CollabDesk</h1>
              <p className='md:text-lg text-base font-semibold text-[#000312]'>Empower your team to work smarter, faster, and together - wherever they are. </p>
